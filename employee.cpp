...
void employee::on_pushButton_choisir_2_clicked()
{
...
void employee::on_modfier_region_b_E_clicked()
{
...
void employee::on_supp_region_E_clicked()
{
...
void employee::on_chercher_cp_F_clicked()
{
...
void employee::on_chercher_tri_reg_clicked()
{
...
void employee::on_chercher_tri_reg_2_clicked()
{
...
void employee::on_retourEE_clicked()
{
    ui->tab_s->setModel(st.afficher());
}


void employee::on_retourFF_clicked()
{
    // ui->tab_reg->setModel(reg.afficher());
}


void employee::on_tri_croissant_reg_clicked()
{
   Emp *R = new Emp();
...
void employee::on_tri_decroissant_reg_clicked()
{
   Emp *R = new Emp();
...
void employee::on_tri_croissant_reg_2_clicked()
{
    conge *R = new conge();
...
void employee::on_tri_decroissant_reg_2_clicked()
{
    conge *R = new conge();
...
void employee::on_stat_regionF_clicked()
{
...
void employee::on_stat_regionE_clicked()
{
    QSqlQueryModel * model= new QSqlQueryModel();
         model->setQuery("select * from congee where nb_jours=0 ");
         int number1=model->rowCount();
         model->setQuery("select * from congee where nb_jours<10  ");
         int number2=model->rowCount();
         model->setQuery("select * from congee where nb_jours>10 ");
         int number3=model->rowCount();
         int total=number1+number2+number3;
...
void employee::on_ajouter_four_clicked()
{
...
void employee::on_modfier_four_clicked()
{
...
void employee::on_ajouter_s_clicked()
{
...
void employee::on_button_reg_E_clicked()
{
